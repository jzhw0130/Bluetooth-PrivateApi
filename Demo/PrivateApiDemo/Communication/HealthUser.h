...
//Add for AM4
@property (strong, nonatomic)NSNumber *stepGoal;
@property (strong, nonatomic)NSNumber *swimGoal;
@property (strong, nonatomic)NSNumber *swimPoolLength;
@property SwimUnit swimUnit;
@property (strong, nonatomic)NSNumber *swimStayTime;
